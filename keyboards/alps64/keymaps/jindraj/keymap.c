...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT_all(
    ...
    KC_CAPS, _______, KC_UP  , _______, _______, KC_PAUS, KC_HOME, KC_PGUP, SS_SBKS, SS_EMPL, _______, _______, _______, QK_BOOT,
    _______, KC_LEFT, KC_DOWN, KC_RGHT, _______, KC_SCRL, KC_END , KC_PGDN, SS_AST , SS_GIS , _______, _______, _______,
